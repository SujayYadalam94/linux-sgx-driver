...
/* YSSU: Initialize all the free lists required for buddy allocator */
...
/*
 * Allocate a regular 4KB page or a 2M large page from the buddy
 * allocator based on the input argument. Returns NULL if buddy 
 * allocator cannot allocate page of required size.
 */
...
/*
 * Add a page back to the buddy allocator. Merge with buddy if possible.
 */

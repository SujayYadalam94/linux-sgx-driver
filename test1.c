...
/*
 * The minimum allocation size is 4KB which is the normal page size.
 */
#define MIN_ALLOC_LOG2 12
#define MIN_ALLOC ((size_t)1 << MIN_ALLOC_LOG2)

/*
 * The maximum allocation size is currently set to 2MB. This is the size of
 * large pages.
 */
 ...
 * MAX_ALLOC (i.e. 2MB or large pages).
 */
static list_t buckets[BUCKET_COUNT];

/*
 * YSSU: need to take a look at this.
...
/*
 * YSSU: I dont think I will be needing this cause the EPC size is predetermined.
...
/*
 * YSSU: need to change this. Only 2 sizes can be requested.
